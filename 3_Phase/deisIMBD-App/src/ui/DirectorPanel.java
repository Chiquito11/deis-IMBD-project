...
public class DirectorPanel extends JPanel {
    ...
    private JPanel createFormPanel() {
        ...
        JLabel titleLabel = new JLabel("Director Management");
        ...
        fieldsPanel.setForeground(Color.BLACK);
        ...
        JButton btnAdd = createStyledButton("Add Director", SUCCESS_COLOR);
        JButton btnDelete = createStyledButton("Delete Director", DANGER_COLOR);
        JButton btnRefresh = createStyledButton("Refresh", PRIMARY_COLOR);
        
        btnAdd.addActionListener(e -> insertDirector());
        btnDelete.addActionListener(e -> deleteSelectedDirector());
        btnRefresh.addActionListener(e -> loadDirectors());
    ...
    private JPanel createTablePanel() {
        ...
        tableModel = new DefaultTableModel(new Object[]{"ID", "Name"/*, "Hidden"*/}, 0) {
            @Override
    ...
    private void loadDirectors() {
        ...
        String sql = "SELECT directorId, directorName, hidden FROM Director WHERE hidden = 0";
    ...
    private void insertDirector() {
        try {
            ...
            String sql = "INSERT INTO Director (directorId, directorName) VALUES (?, ?)";
            try (Connection conn = DbConnection.getConnection();
    ...
    private void deleteSelectedDirector() {
        int row = table.getSelectedRow();
        if (row < 0) {
            JOptionPane.showMessageDialog(this, "Please select a director from the table.", "No Selection", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        int id = (Integer) tableModel.getValueAt(row, 0);
        int confirm = JOptionPane.showConfirmDialog(this, 
            "Are you sure you want to soft delete this director?", 
            "Confirm Deletion", 
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            try (Connection conn = DbConnection.getConnection();
                ...
                ps.executeUpdate();
                loadDirectors();
                JOptionPane.showMessageDialog(this, "Director ´deleted´ successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
            } catch (SQLException ex) {
                showError(ex);
            }
        }
